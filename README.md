...
|---|---|---|---|
| <img src="https://raw.githubusercontent.com/toneron2/toneron2/main/icons/physicalized-agent.png" width="64" alt="physicalized‑agent"> | **[physicalized‑agent](https://github.com/toneron2/physicalized-agent)** | A low-cost healthcare sensor head: stereo cameras, two MEMS microphones in acoustic horns, a Raspberry Pi 5 in the prototype. Deterministic signal processing produces bearings and ranges; a local state machine handles safety; telemetry streams to the portal over WebTransport. | Procurement in process. |
...
| | **[igent](https://github.com/toneron2/igent)** | The contract between an igent device and its portal: one WebTransport connection, a heartbeat datagram, control and agent streams, a verdict from URGE on every call. | Procurement in process. |
| | **[identities](https://github.com/toneron2/identities)** | Six named agents as the faces of BROAD's roles, and the status line every igent device renders: who acted, what they did, whether URGE allowed it. | Procurement in process. |
| | **[bolt-buddy](https://github.com/toneron2/bolt-buddy)** | The ride-along igent: reads a vehicle's own data and the ride-hail platforms, never controls the vehicle. | Procurement in process. |
| | **[silent-drone](https://github.com/toneron2/silent-drone)** | The igent that moves: on-board navigation, portal steering with a verdict, ducted rotors for night-time ward monitoring. | Procurement in process. |
